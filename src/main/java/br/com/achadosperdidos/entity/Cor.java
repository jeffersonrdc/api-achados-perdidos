...
@Entity @Table(name = "cor")
public class Cor {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) @Column(name = "ID_Cor") private Long id;
    @Column(name = "NM_Cor", nullable = false, length = 60) private String nmCor;
    @Column(name = "CD_Hex", length = 7) private String cdHex;
    ...
    public String getCdHex() { return cdHex; } public void setCdHex(String v) { this.cdHex = v; }
