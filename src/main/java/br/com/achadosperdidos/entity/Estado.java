...
public class Estado {
    ...
    @Column(name = "ID_Estado") private Long id;
    @Column(name = "NM_Estado", nullable = false, length = 60) private String nmEstado;
    @Column(name = "DS_Estado", length = 255) private String dsEstado;
    ...
    public String getDsEstado() { return dsEstado; } public void setDsEstado(String v) { this.dsEstado = v; }
